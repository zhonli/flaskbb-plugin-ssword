...
update-translations:
	pybabel extract -F babel.cfg -k lazy_gettext -o ssword/translations/messages.pot .
	pybabel update -i ssword/translations/messages.pot -d ssword/translations/

add-translation:
	@read -p "Enter new language shortcode:" lang; \
	pybabel init -i ssword/translations/messages.pot -d ssword/translations/ -l $$lang

compile-translations:
	pybabel compile -d ssword/translations/
